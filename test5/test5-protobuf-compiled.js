...
const ProtobufType = require('./test5-protobuf-compiled-proto').testpackage.TimeframeData;
...
const { result: buf, duration: encodingDuration } = benchmark(() => ProtobufType.encode(data).finish());

const { result: source, duration: decodingDuration } = benchmark(() => ProtobufType.decode(buf));
